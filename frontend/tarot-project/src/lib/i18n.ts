...
export type TranslationKey = keyof TranslationMap['ko'];

export function t<K extends TranslationKey>(key: K, locale: Locale = DEFAULT_LOCALE): TranslationMap[Locale][K] {
  return translations[locale][key] as TranslationMap[Locale][K];
}

export function getTranslations(locale: Locale = DEFAULT_LOCALE): TranslationMap[Locale] {
