    ...
    <main className="relative min-h-screen">
      ...
      <div className="relative z-10 pb-12">
        {readingFlow.appState === 'idle' && (
          <div className="animate-fade-in">
            {questionCategoryManifest ? (
              ...
              <ErrorDisplay message={questionCategoryError} onRetry={retryQuestionCategoryManifest} locale={locale} />
            ) : (
        ...
        {readingFlow.appState === 'error' && (
          <ErrorDisplay message={readingFlow.error} onRetry={readingFlow.handleReset} locale={locale} />
        )}
      </div>
